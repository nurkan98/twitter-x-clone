...
export default function Menu() {
    return (
        <nav className="mt-0.5 mb-1">
            <NavLink to="/" className="pt-1 block group">
                {({ isActive }) => (
                    <div className={classNames("p-3 rounded-full transition-colors inline-flex items-center gap-5 group-block group-hover:bg-[#eff3f41a]", { "font-bold": isActive })}>
                        {!isActive && (
            ...
            <NavLink to="/explore" className="pt-1 block group">
                {({ isActive }) => (
                    <div className={classNames("p-3 rounded-full transition-colors inline-flex items-center gap-5 group-block group-hover:bg-[#eff3f41a]", { "font-bold": isActive })}>
                        {!isActive && (
                            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
